...
export default function Account() {
  ...
  return (
    <main className="flex flex-col relative py-20 px-4">
      ...
      <div className="container mx-auto flex relative justify-center md:justify-end">
       {
        ...
        <div data-aos="fade-down" data-aos-delay="1000" className="flex items-center gap-1 border border-dark/20 text-dark/50 p-2">
          <IoKeyOutline />
      ...
      :
      <form action="" className="bg-white p-4 shad md:shadow-none flex flex-col rounded-md gap-4 w-full max-w-md">
      <h3 data-aos="zoom-in-down" data-aos-delay="100" className="text-primary text-xl md:text-3xl text-center font-bold"><span className="text-secondary"> Enjoy Incredible Offers </span>when you Sign up</h3>
      ...
      <div data-aos="fade-up" data-aos-delay="1500" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
        <BsPersonSquare />
        <input type="text" value={inputs.lastNameName} name='lastname' onChange={handleChange} required placeholder='Last Name e.g. Emily' className="flex-1 p-1 outline-none" />
      </div>
      

      <div data-aos="fade-up" data-aos-delay="1500" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
        <TbMailForward />
        <input type="email" value={inputs.email} onChange={handleChange} required placeholder='Emilyduncan@email.com' className="flex-1 p-1 outline-none" />
      </div>
